...
window.addEventListener("load", function () {
    ...
    document.querySelector("#table1_1_2").appendChild(document.createTextNode("장비명"))
    document.querySelector("#table1_1_3").appendChild(document.createTextNode("가동시간"))
    document.querySelector("#table1_1_4").appendChild(document.createTextNode("실가동률"))
    ...
    document.querySelector("#table1_1_7").appendChild(document.createTextNode("가동비용"))
})