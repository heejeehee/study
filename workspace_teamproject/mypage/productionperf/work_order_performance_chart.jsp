<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/work_order_performance_chart.css">
        <script src="../js/work_order_performance_chart.js"></script>
    </head>
    <style>
            ...
            <div id="content">
                ...
                <div class="updiv">
                    ...
                    <div id="selbox_div">
                        ...
                        <select name="work_name" id="wname">
                            <option value="select">작업명</option>
                        </select>
                        <select name="workChart" id="work_chart">
