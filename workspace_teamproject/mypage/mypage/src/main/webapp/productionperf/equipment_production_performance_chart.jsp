<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/equipment_production_performance_chart.css">
        <script src="../js/equipment_production_performance_chart.js"></script>
    </head>
    <style>
            ...
            <div id="content">
                ...
                <div class="updiv">
                    ...
                    <div id="selbox_div">
                        ...
                        <select name="equipment_work_time" id="ewtime">
