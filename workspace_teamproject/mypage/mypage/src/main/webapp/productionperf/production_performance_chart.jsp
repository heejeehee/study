<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/production_performance_chart.css">
        <script src="../js/production_performance_chart.js"></script>
    </head>
    <style>
            ...
            <div id="content">
                ...
                <div class="updiv">
                    ...
                    <div id="selbox_div">
                        ...
                        <select name="pcbType" id="pcb_type">
                            <option value="1">pcb명</option>
                        </select>
                        <select name="pcbChart" id="pcb_chart">
