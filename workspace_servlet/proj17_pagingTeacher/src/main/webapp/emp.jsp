		...
		<c:if test="${not empty list}">
			<c:forEach var="vo" items="${list}" varStatus="status">
				<tr>
					...
					<td>${ vo.lv }</td>
					<td>${ vo.empno }</td>
					<td style="padding-left: ${ (vo.lv) * 10 }px;">
	<%-- 				<c:if test="${vo.lv != 0 }">  --%>
...
<!-- 	[1] [<a href="/proj17_paging/emp?pageNum=2">2</a>] [<a href="/proj17_paging/emp?pageNum=3"><strong>3</strong></a>] [<a href="/proj17_paging/emp?pageNum=4">4</a>] [5]  -->
